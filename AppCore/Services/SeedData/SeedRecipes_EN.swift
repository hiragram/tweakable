...
extension SeedData {
    static let englishRecipes: [Recipe] = [
        ...
        Recipe(
            ...
            steps: [
                CookingStep(stepNumber: 1, instruction: "Preheat oven to 350\u{00B0}F. Grease and flour two 12-cup cupcake tins."),
        ...
        Recipe(
            ...
            steps: [
                CookingStep(stepNumber: 1, instruction: "Line an 8\u{00D7}8 inch pan with parchment paper, leaving overhang on all sides for easy removal."),
                ...
                CookingStep(stepNumber: 3, instruction: "Preheat the oven to 350\u{00B0}F."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Thinly sliced yellow onion (about \u{00BD} large)", amount: "1 cup"),
                    Ingredient(name: "Sliced pastrami, cut into 1-inch pieces", amount: "8 oz"),
                    Ingredient(name: "Garlic powder", amount: "\u{00BD} tsp"),
                    Ingredient(name: "Smoked paprika", amount: "\u{00BD} tsp"),
                    Ingredient(name: "Cayenne", amount: "\u{00BD} tsp"),
                    Ingredient(name: "Kosher salt and black pepper", amount: "to taste"),
                    Ingredient(name: "Premade pizza dough", amount: "16 oz"),
                    Ingredient(name: "Honey barbecue sauce", amount: "\u{2153} cup"),
            ...
            steps: [
                ...
                CookingStep(stepNumber: 3, instruction: "Preheat grill or grill pan on medium. Stretch the dough into a 12\u{00D7}8-inch rectangle. Oil the grill surface, transfer the dough, and cook 4 minutes per side until golden and crispy."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Heirloom tomatoes, cored and cut into 1-inch wedges", amount: "2 large (~3\u{00BD} cups)"),
                    Ingredient(name: "Kosher salt", amount: "\u{00BD} teaspoon (plus more to taste)"),
                    Ingredient(name: "Garlic cloves, microplaned or minced", amount: "2 (~1 teaspoon)"),
                    Ingredient(name: "Balsamic vinegar", amount: "\u{00BD} cup"),
                    Ingredient(name: "Extra virgin olive oil", amount: "\u{00BD} cup"),
                    ...
                    Ingredient(name: "Basil, large leaves torn", amount: "\u{00BE} cup loosely packed (~\u{00BD} ounce)"),
                    Ingredient(name: "Red onion, thinly sliced", amount: "\u{00BD} cup"),
                    Ingredient(name: "Fresh mozzarella, cut into 1-inch pieces", amount: "1 ball (8 ounces)"),
                ]
            ),
            steps: [
                CookingStep(stepNumber: 1, instruction: "Preheat oven to 350\u{00B0}F."),
                ...
                CookingStep(stepNumber: 3, instruction: "Set a colander over a mixing bowl. Add tomatoes, sprinkle with \u{00BD} teaspoon salt, and let sit for 10 minutes to drain. Reserve the tomato liquid."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Neutral oil", amount: "\u{00BC} cup"),
                    Ingredient(name: "Kosher salt", amount: "To taste"),
                    Ingredient(name: "Egg yolks", amount: "2"),
                    Ingredient(name: "Lemon juice", amount: "2 teaspoons"),
                    Ingredient(name: "Worcestershire sauce", amount: "\u{00BD} teaspoon"),
                    ...
                    Ingredient(name: "Russet potatoes, scrubbed and cut into \u{00BC} inch matchsticks", amount: "4"),
                    Ingredient(name: "Freshly grated Parmesan", amount: "\u{00BC} cup"),
            ...
            steps: [
                ...
                CookingStep(stepNumber: 5, instruction: "Heat 1\u{00BD} inches of vegetable oil to 350\u{00B0}F in a deep skillet. Fry the potatoes in batches for 3\u{2013}4 minutes until the edges start to brown. Transfer to the prepared baking sheets. Check the oil temperature between batches."),
                CookingStep(stepNumber: 6, instruction: "Increase the oil temperature to 400\u{00B0}F. Fry the pre-cooked potatoes again for 1\u{2013}2 minutes until crispy and golden brown all around. Transfer to clean paper towels."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Fresh dill, roughly chopped", amount: "\u{00BC} cup"),
                    Ingredient(name: "Kosher salt", amount: "3 tablespoons"),
                    Ingredient(name: "Sugar", amount: "1\u{00BD} tablespoons"),
                    Ingredient(name: "Freshly ground black pepper", amount: nil),
                    Ingredient(name: "Neutral oil (vegetable or grapeseed)", amount: nil),
                    Ingredient(name: "Russet potatoes", amount: "2\u{00BD} pounds (4-5 medium)"),
            ...
            steps: [
                ...
                CookingStep(stepNumber: 4, instruction: "Heat oil in a skillet over medium-high heat. Form half-cup portions of the potato mixture into \u{00BD}-inch thick pancakes and fry for 6-7 minutes until golden. Flip and repeat. Transfer to paper towels and salt generously."),
        ...
        Recipe(
            ...
            steps: [
                ...
                CookingStep(stepNumber: 3, instruction: "Heat oil to 400\u{00B0}F and deep fry the circles until they puff up and turn golden. Drain on paper towels."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                servings: "6 buns",
                items: [
                    Ingredient(name: "Milk", amount: "\u{00BD} cup"),
                    Ingredient(name: "Granulated sugar", amount: "\u{00BC} cup"),
                    Ingredient(name: "Platinum yeast", amount: "1 packet (\u{00BC} oz)"),
                    Ingredient(name: "Butter, cubed and softened", amount: "4 tablespoons"),
                    Ingredient(name: "Egg, room temperature", amount: "1"),
                    Ingredient(name: "Kosher salt", amount: "\u{00BC} teaspoon"),
                    Ingredient(name: "All-purpose flour", amount: "2 cups"),
                    Ingredient(name: "Apple butter", amount: "\u{00BD} cup"),
                    Ingredient(name: "Dark brown sugar", amount: "2 tablespoons"),
                    Ingredient(name: "Cinnamon", amount: "\u{00BC} teaspoon"),
                    Ingredient(name: "Ground cloves", amount: "\u{215B} teaspoon"),
                    Ingredient(name: "Ground allspice", amount: "\u{215B} teaspoon"),
                    Ingredient(name: "Freshly grated nutmeg", amount: "Pinch"),
                    Ingredient(name: "Salt", amount: "Pinch"),
                    Ingredient(name: "Walnuts, finely chopped", amount: "\u{00BD} cup"),
                    Ingredient(name: "Granulated sugar (for caramel)", amount: "\u{00BE} cup"),
                    Ingredient(name: "Salted butter, cold and cubed", amount: "4 tablespoons"),
                    Ingredient(name: "Pink Lady apple, peeled and cored, \u{00BC}\" slices", amount: "1"),
                    Ingredient(name: "Beaten egg (for egg wash)", amount: "1"),
                ]
            ),
            steps: [
                CookingStep(stepNumber: 1, instruction: "Heat the milk to 90\u{2013}105\u{00B0}F. Combine with sugar and yeast in the bowl of a stand mixer. Let sit for 5\u{2013}10 minutes until foamy."),
                ...
                CookingStep(stepNumber: 5, instruction: "Roll the dough into a 10\u{00D7}12-inch rectangle. Spread the filling evenly, sprinkle with walnuts, and roll up tightly. Cut into 6 equal pieces. Grease a 9-inch pie pan."),
                CookingStep(stepNumber: 6, instruction: "Make the caramel: cook the sugar undisturbed for 4 minutes over medium-high heat, then whisk for 1\u{2013}2 minutes until dark amber. Remove from heat and whisk in the cold butter. Pour into the pie pan, arrange apple slices on top, then place the buns cut-side up. Cover with foil and let rise for 30 minutes."),
                CookingStep(stepNumber: 7, instruction: "Preheat the oven to 375\u{00B0}F. Brush the buns with egg wash and bake for 25 minutes until golden brown. Cool for 15\u{2013}30 minutes, then invert onto a serving platter."),
            ],
        ...
        Recipe(
            ...
            description: "Korean fried chicken-inspired crispy popcorn chicken served with two sauces \u{2013} sweet honey mustard and spicy gochujang buffalo \u{2013} plus homemade quick pickles.",
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    Ingredient(name: "Kirby cucumbers, sliced \u{215B} inch thick", amount: "3"),
                    Ingredient(name: "Thinly sliced onion", amount: "\u{00BD} cup"),
                    ...
                    Ingredient(name: "Sugar", amount: "\u{00BD} cup"),
                    Ingredient(name: "Kosher salt", amount: "1 teaspoon"),
                    Ingredient(name: "Turmeric", amount: "\u{00BC} teaspoon"),
                    Ingredient(name: "Ice cubes", amount: "1 cup"),
                    Ingredient(name: "Dijon mustard", amount: "\u{00BC} cup"),
                    Ingredient(name: "Whole grain mustard", amount: "2 tablespoons"),
                    Ingredient(name: "Honey", amount: "\u{00BC} cup"),
                    Ingredient(name: "Garlic cloves, grated", amount: "4"),
                    Ingredient(name: "Frank's Red Hot sauce", amount: "\u{00BD} cup"),
            ...
            steps: [
                ...
                CookingStep(stepNumber: 6, instruction: "Line 2 sheet pans with paper towels. Heat 3 inches of vegetable oil to 325\u{00B0}F in a Dutch oven."),
                ...
                CookingStep(stepNumber: 9, instruction: "Increase oil temperature to 400\u{00B0}F and refry all the chicken pieces for 2-3 minutes until medium golden brown. Transfer to the second pan and season with salt."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Smoked paprika", amount: "\u{00BD} teaspoon"),
                    Ingredient(name: "Cayenne", amount: "\u{215B} teaspoon"),
            ...
            steps: [
                ...
                CookingStep(stepNumber: 3, instruction: "Add 1 tablespoon of butter to the same skillet. Saut\u{00E9} the scallion whites and bell pepper until soft and translucent, 8\u{2013}10 minutes. Add the garlic, tomato, smoked paprika, and cayenne. Cook for 2\u{2013}3 minutes until fragrant. Sprinkle in the flour and stir for 1\u{2013}2 minutes, then gradually add the vegetable stock while stirring. Simmer for 2\u{2013}3 minutes until lightly thickened. Taste and adjust seasonings."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                servings: "4 servings",
                items: [
                    Ingredient(name: "Granulated sugar", amount: "\u{00BD} cup"),
                    Ingredient(name: "Fresh mint leaves, tightly packed", amount: "\u{00BD} cup"),
                    Ingredient(name: "Raspberries (about 3 cups)", amount: "2 (6 oz) containers"),
                    Ingredient(name: "Lime, juiced", amount: "1 (\u{00BC} cup)"),
                    Ingredient(name: "White balsamic vinegar", amount: "\u{00BC} cup"),
                ]
            ),
            steps: [
                CookingStep(stepNumber: 1, instruction: "Combine sugar, \u{00BD} cup water, and mint in a small saucepan over medium heat. Simmer until sugar dissolves, then cool completely for 1 hour. Strain into a serving pitcher."),
        ...
        Recipe(
            ...
            steps: [
                CookingStep(stepNumber: 1, instruction: "Preheat the oven to 325\u{00B0}F."),
        ...
        Recipe(
            ...
            ingredientsInfo: Ingredients(
                ...
                items: [
                    ...
                    Ingredient(name: "Ghee or butter, melted", amount: "\u{00BC} cup"),
                    Ingredient(name: "Mint leaves", amount: "1 \u{00BD} cups"),
                    Ingredient(name: "Cilantro leaves and tender stems", amount: "1 cup"),
                    Ingredient(name: "Small Indian green chili", amount: "1"),
                    Ingredient(name: "Small yellow onion", amount: "\u{00BD}"),
                    Ingredient(name: "Lemon, juiced", amount: "1"),
                    Ingredient(name: "Ginger, peeled", amount: "\u{00BD} inch"),
                    Ingredient(name: "Garlic cloves, peeled", amount: "2"),
                    Ingredient(name: "Cumin", amount: "\u{00BD} tsp"),
                    ...
                    Ingredient(name: "Vegetable oil", amount: "\u{00BC} cup"),
                    ...
                    Ingredient(name: "Small red onion, thinly sliced", amount: "\u{00BD}"),
                    Ingredient(name: "Cilantro leaves", amount: "\u{00BD} cup"),
                ]
            ),
            steps: [
                CookingStep(stepNumber: 1, instruction: "Make the roti dough: Mix flour, salt, and oil in a bowl. Add 1 cup water and mix until dough forms. Knead 3\u{2013}4 minutes until smooth. Cover and rest for at least 20 minutes."),
                ...
                CookingStep(stepNumber: 5, instruction: "Make the mint chutney: Blend mint, cilantro, green chili, onion, lemon juice, ginger, garlic, and cumin in a food processor. Stream in \u{00BC} cup water until reaching a pesto-like consistency."),
                ...
                CookingStep(stepNumber: 7, instruction: "Heat oil in a large skillet over high heat. Spread potatoes in a thin layer, season with salt and pepper. Cook 3\u{2013}4 minutes per side until golden, flipping occasionally. Stir in chaat masala."),
                CookingStep(stepNumber: 8, instruction: "Make the chili paneer: Heat oil in a large skillet over high heat. Cook red pepper and green chilis 4\u{2013}5 minutes until edges brown. Add paneer and cook 4\u{2013}5 minutes until golden."),
                ...
                CookingStep(stepNumber: 10, instruction: "Make the scrambled eggs: Melt butter in a non-stick pan over low heat. Add cumin seeds and cook 30\u{2013}45 seconds until sizzling and fragrant."),
                CookingStep(stepNumber: 11, instruction: "Add beaten eggs and stir continuously for 3\u{2013}4 minutes until 90% set with slight liquid remaining. Remove from heat immediately."),
                CookingStep(stepNumber: 12, instruction: "Assemble: Place a roti on a work surface. Layer \u{00BC} of the hash browns, chili paneer, scrambled eggs, red onion slices, cilantro, and a drizzle of mint chutney in the center. Fold the nearest side over, fold in the sides, and roll tightly. Serve immediately."),
            ],

...
/// 担当者選択View
public struct AssignmentPickerView_Okumuka: View {
...
struct AssignmentDayRowView_Okumuka: View {
...
struct AssignmentSectionView_Okumuka: View {
    let title: String
        ...
        VStack(alignment: .leading, spacing: theme.spacing.xs) {
            ...
            VStack(spacing: theme.spacing.xs) {
                ForEach(members) { availability in
                    AssignmentMemberRowView_Okumuka(
...
struct AssignmentMemberRowView_Okumuka: View {
    ...
    var body: some View {
        Button(action: onTap) {
            HStack(spacing: theme.spacing.sm) {
                ...
                // Status icon
                AssignmentStatusIconView_Okumuka(status: status, theme: theme)
            }
        ...
        .disabled(isDisabled)
        .buttonStyle(AssignmentMemberRowButtonStyle_Okumuka())
        .accessibilityIdentifier(AssignmentPickerView_Okumuka.AccessibilityID.memberRow(participantID: member.participantID))
    }
}

struct AssignmentMemberRowButtonStyle_Okumuka: ButtonStyle {
...
struct AssignmentStatusIconView_Okumuka: View {
    let status: MemberAvailabilityStatus
    let theme: DesignSystem
...
#Preview("AssignmentPickerView_Okumuka") {
...
#Preview("AssignmentPickerView_Okumuka - DarkMode") {
    AssignmentPickerView_Okumuka(
        assignments: DayAssignmentUI.mockWeek(),
        onDropOffSelected: { _, _ in },
        onPickUpSelected: { _, _ in },

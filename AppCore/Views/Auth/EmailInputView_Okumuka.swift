...
/// メールアドレス入力画面（ログイン）
struct EmailInputView_Okumuka: View {
...
#Preview("EmailInputView_Okumuka") {
...
#Preview("EmailInputView_Okumuka_WithEmail") {
    EmailInputView_Okumuka(
...
#Preview("EmailInputView_Okumuka_Sending") {
    EmailInputView_Okumuka(
        email: "test@example.com",
        isSending: true,
        errorMessage: nil,
...
#Preview("EmailInputView_Okumuka_Error") {
    EmailInputView_Okumuka(
        email: "test@example.com",
        isSending: false,

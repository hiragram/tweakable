...
/// OTP（6桁認証コード）入力画面
struct OTPInputView_Okumuka: View {
...
#Preview("OTPInputView_Okumuka_WithOTP") {
    OTPInputView_Okumuka(
        email: "test@example.com",
        otp: "123456",
        isVerifying: false,
...
#Preview("OTPInputView_Okumuka_Verifying") {
    OTPInputView_Okumuka(
        email: "test@example.com",
        otp: "123456",
        isVerifying: true,
...
#Preview("OTPInputView_Okumuka_Error") {
    OTPInputView_Okumuka(
        email: "test@example.com",
        otp: "123456",
        isVerifying: false,

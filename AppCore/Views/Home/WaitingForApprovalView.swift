...
#Preview("WaitingForApprovalView") {
    WaitingForApprovalView(groupName: "山田家", isLoading: false, onReload: {})
        .prefireEnabled()
}

#Preview("WaitingForApprovalView - Loading") {
    WaitingForApprovalView(groupName: "山田家", isLoading: true, onReload: {})
        .prefireEnabled()
}

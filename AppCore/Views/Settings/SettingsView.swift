...
struct SettingsView<GroupSettingsDestination: View>: View {
...
#Preview("SettingsView - WithLocations") {
    let locations = [
        WeatherLocation(
            label: "家",
            latitude: 35.6762,
...
#Preview("SettingsView - OneLocation") {
    let locations = [
        WeatherLocation(
            label: "家",
            latitude: 35.6762,

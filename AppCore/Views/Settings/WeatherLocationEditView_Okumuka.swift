...
struct WeatherLocationEditView_Okumuka: View {
...
#Preview("WeatherLocationEditView_Okumuka - Add") {
...
#Preview("WeatherLocationEditView_Okumuka - Selected") {
    WeatherLocationEditView_Okumuka(
        mode: .add,
        region: MKCoordinateRegion(
            center: CLLocationCoordinate2D(latitude: 35.6762, longitude: 139.6503),
...
#Preview("WeatherLocationEditView_Okumuka - Edit") {
    ...
    return WeatherLocationEditView_Okumuka(
        mode: .edit(location),
        region: MKCoordinateRegion(
            center: CLLocationCoordinate2D(latitude: 35.6762, longitude: 139.6503),
            span: MKCoordinateSpan(latitudeDelta: 0.01, longitudeDelta: 0.01)
...
#Preview("WeatherLocationEditView_Okumuka - Loading") {
    WeatherLocationEditView_Okumuka(
        mode: .add,
        region: MKCoordinateRegion(
            center: CLLocationCoordinate2D(latitude: 35.6762, longitude: 139.6503),

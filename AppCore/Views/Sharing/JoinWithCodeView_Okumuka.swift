...
struct JoinWithCodeView_Okumuka: View {
...
#Preview("JoinWithCodeView_Okumuka - Idle") {
...
#Preview("JoinWithCodeView_Okumuka - Input") {
    JoinWithCodeView_Okumuka(
...
#Preview("JoinWithCodeView_Okumuka - Joining") {
    JoinWithCodeView_Okumuka(
...
#Preview("JoinWithCodeView_Okumuka - Success") {
    JoinWithCodeView_Okumuka(
        codeInput: .constant("ABC123"),
        isJoining: false,
...
#Preview("JoinWithCodeView_Okumuka - Error") {
    JoinWithCodeView_Okumuka(
        codeInput: .constant("ABC123"),
        isJoining: false,
        joinedGroup: nil,
